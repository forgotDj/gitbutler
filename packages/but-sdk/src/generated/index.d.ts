 ...
 *
 * The variant name itself is the wire-level identifier: serde serializes each
 * variant as its name, the `Display` impl emits the same string, and the
 * frontend imports the matching union (`Code`) from `@gitbutler/but-sdk`.
 */
