...
export const projectSlice = createSlice({
	...
	reducers: {
		...
		selectBranches: withProject(projectReducers.selectBranches),
	...
	selectors: {
		...
		selectPrimaryBranchesSelection: fromProject(projectSelectors.selectPrimaryBranchesSelection),
		selectSelectionBranches: fromProject(projectSelectors.selectSelectionBranches),
