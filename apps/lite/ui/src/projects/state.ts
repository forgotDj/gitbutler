...
export const projectSlice = createSlice({
	...
	reducers: {
		...
		toggleShowEmptyBranches: withProject(projectReducers.toggleShowEmptyBranches),
		toggleOnlyLocal: withProject(projectReducers.toggleOnlyLocal),
		toggleOnlyStacks: withProject(projectReducers.toggleOnlyStacks),
	},
	selectors: {
		...
		selectShowEmptyBranches: fromProject(projectSelectors.selectShowEmptyBranches),
		selectOnlyLocal: fromProject(projectSelectors.selectOnlyLocal),
		selectOnlyStacks: fromProject(projectSelectors.selectOnlyStacks),
